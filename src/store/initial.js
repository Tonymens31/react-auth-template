...
export const initialState = {
  sidebarShow:
    localStorage.getItem(config.key.sideBarShow) !== "responsive"
      ? JSON.parse(localStorage.getItem(config.key.sideBarShow))
      : localStorage.getItem(config.key.sideBarShow),
